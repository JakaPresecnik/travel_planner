...
const buildTrips = (savedObject, dayToday) => {
  ...
  <div class="saved">
    ...
    <div class="buttons">
      <button class="remove" onclick="return Client.removeTrip(event)" >remove</button>
      <button class="tosee" onclick="return Client.additionalTrips(event)">visit places</button>
    </div>
    <div class="days-away">
